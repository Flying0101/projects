              ...
              <article className="flex max-w-xl flex-col items-start justify-between px-3 py-6 rounded-md shadow-xl" key={file.id}>
                ...
                <div className="group relative">
                  ...
                  <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">
                    A fully custom web solution with the ability to change part
                    of the website however you need them to be, and no need of
                    an developer to keep the site up to date.
                  </p>
                </div>
              </article>
            ))}
